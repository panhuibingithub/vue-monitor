...
mejs.html5media = {
  ...
  */
	properties: [
	// GET/SET
	'volume', 'src', 'currentTime', 'muted', "videoWidth", "videoHeight",

	// GET only   ---  bytestotal bytesloaded for flash
  ...
  * @type {String[]}
  */
	methods: ['load', 'play', 'pause', 'canPlayType', 'stop', 'systemOnTimer', 'capturePic'],
	/**
  * @type {String[]}
  */
	...
	exitFullScreen: function exitFullScreen() {
		...
		if (t.options.setDimensions) {
			...
			if (isNative) {
				...
				t.container.find('iframe').width(t.normalWidth).height(t.normalHeight);
				t.container.find('embed, object, video').width('100%').height('100%');
			}
...
},{"16":16,"2":2,"22":22,"3":3,"4":4,"6":6}],9:[function(_dereq_,module,exports){
'use strict';
...
},{"16":16,"22":22,"27":27,"4":4}],11:[function(_dereq_,module,exports){
'use strict';
...
},{"16":16,"27":27,"4":4,"6":6}],13:[function(_dereq_,module,exports){
'use strict';
...
},{"16":16,"22":22,"4":4}],14:[function(_dereq_,module,exports){
'use strict';
...
var MediaElementPlayer = function () {
	function MediaElementPlayer(node, o) {
		...
		var playerIndex = t.$media.closest('.media-wrapper').attr("playerIndex");
		// unique ID
		t.id = '' + playerIndex;
						...
						t.clickToPlayPauseCallback = function () {
							...
							if (t.options.clickToPlayPause) {
								var button = t.$media.closest('.' + t.options.classPrefix + 'container').find('.' + t.options.classPrefix + 'overlay-button'),
								    pressed = Boolean(button.attr('aria-pressed') == "true");
								if (t.media.paused && !pressed) {
									t.pause();
								} else if (t.media.paused || !t.playStatus) {
									// 暂停或者flash 断开连接
									t.play();
									t.playStatus = true;
								} else {
									if (t.options.playPauseType == 0) {
										t.pause();
									} else if (t.options.playPauseType == 1) {
										t.pause();
										if (t.stop) {
											t.stop();
											t.playStatus = false;
   ...
   */
		...
		value: function setPoster(url) {
			...
			if (url) {
				...
				$(t.options.classPrefix + 'poster').remove();
			}
		}
	}, {
		key: 'changeSkin',
		...
		value: function buildposter(player, controls, layers, media) {
			...
			media.addEventListener('play', function () {
				if (!media.rendererName.match(/flash_video/)) {
					poster.hide();
				} else {
					if (t.playType == "FLV") {
						poster.hide();
			...
			media.addEventListener('flashBufFull', function () {
				poster.hide();
			}, false);
		...
		value: function buildoverlays(player, controls, layers, media) {
			...
			media.addEventListener('playing', function () {
				bigPlay.hide();
				//flash 在缓冲满后触发loading 消失
				if (!media.rendererName.match(/flash_video/) || t.playType == "FLV") {
					loading.hide();
				}
				controls.find('.' + t.options.classPrefix + 'time-buffering').hide();
				error.hide();
			...
			media.addEventListener('flashBufFull', function () {
				...
				loading.hide();
				controls.find('.' + t.options.classPrefix + 'time-buffering').show();
				console.debug("--------flashBufFull-----------");
			}, false);

			media.addEventListener('flashBufEmpty', function () {

				loading.show();
				controls.find('.' + t.options.classPrefix + 'time-buffering').show();
				console.debug("--------flashBufEmpty-----------");
			}, false);

			media.addEventListener('flashSuccess', function () {
				console.debug("--------flashSuccess-----------");
			}, false);

			media.addEventListener('flashClose', function () {
				t.playStatus = false;
				console.debug("--------flashSuccess-----------");
			}, false);
		...
		value: function play() {
			...
			try {
				if (t.media.rendererName == "flash_video" || t.media.paused) {
					t.media.play();
				}
			} catch (e) {}
		}
...
},{"2":2,"22":22,"23":23,"24":24,"25":25,"27":27,"3":3,"4":4,"5":5,"6":6}],17:[function(_dereq_,module,exports){
'use strict';
...
},{"2":2,"22":22,"23":23,"25":25,"3":3,"6":6,"7":7}],18:[function(_dereq_,module,exports){
'use strict';
...
var FlashMediaElementRenderer = {
  ...
  */
	create: function create(mediaElement, options, mediaFiles) {
		...
		flash.flashWrapper.style.width = '100%';
		flash.flashWrapper.style.height = '100%';
		var autoplay = !!mediaElement.getAttribute('autoplay'),
		    flashVars = ['uid=' + flash.id, 'autoplay=' + autoplay],
		    isVideo = mediaElement.originalNode !== null && mediaElement.originalNode.tagName.toLowerCase() === 'video',
		    flashHeight = isVideo ? '100%' : 1,
		    flashWidth = isVideo ? '100%' : 1;
		...
		flash.setSize = function (width, height) {
			flash.flashNode.style.width = '100%';
			flash.flashNode.style.height = '100%';

			if (flash.flashApi !== null && typeof flash.flashApi.fire_setSize === 'function') {
				flash.flashApi.fire_setSize('100%', '100%');
			}
		};
...
},{"2":2,"22":22,"23":23,"25":25,"3":3,"4":4,"6":6,"7":7}],19:[function(_dereq_,module,exports){
'use strict';
	...
	loadScript: function loadScript(settings) {
		if (!NativeFlv.isMediaStarted) {
			...
			if (typeof flvjs !== 'undefined') {
				...
				settings.options.path = typeof settings.options.path === 'string' ? settings.options.path : 'plugin/flv.min.js';
				var script = _document2['default'].createElement('script'),
				    firstScriptTag = _document2['default'].getElementsByTagName('script')[0],
				    done = false;
  ...
  */
	create: function create(mediaElement, options, mediaFiles) {
				...
				if (!_mejs2['default'].html5media.readOnlyProperties.includes(propName)) {
					if (flvPlayer !== null) {
						...
						if (propName === 'src') {
							...
							if (options.flv.segments && options.flv.segments.length > 0) options.flv.segments[0].url = value;
							NativeFlv.createInstance({
								options: options.flv,
		...
		_window2['default']['__ready__' + id] = function (_flvPlayer) {
			...
			//add flvError event
			flvPlayer.on('error', function (type, exception, data) {
				var event = (0, _dom.createEvent)('flvError', node);
				event.data = data;
				mediaElement.dispatchEvent(event);
			});
			flvPlayer.on('statistics_info', function (info) {
				var event = (0, _dom.createEvent)('statisticsInfo', node);
				event.data = info;
				mediaElement.dispatchEvent(event);
			});
		};
		...
		if (options.flv.segments && options.flv.segments.length > 0) options.flv.segments[0].url = node.getAttribute('src');
...
},{"2":2,"22":22,"23":23,"25":25,"3":3,"6":6,"7":7}],20:[function(_dereq_,module,exports){
'use strict';
	...
	loadScript: function loadScript(settings) {
		if (!NativeHls.isMediaStarted) {
			...
			if (typeof Hls !== 'undefined') {
				...
				settings.options.path = typeof settings.options.path === 'string' ? settings.options.path : 'plugin/hls.min.js';
...
var HlsNativeRenderer = {
   ...
   */
		hls: {
			...
			manifestLoadingMaxRetryTimeout: 34000, //64000,
			levelLoadingTimeOut: 10000,
			levelLoadingMaxRetry: 3, //6,
			levelLoadingRetryDelay: 500,
			levelLoadingMaxRetryTimeout: 34000, //64000,
			fragLoadingTimeOut: 20000,
			fragLoadingMaxRetry: 3, //6,
			fragLoadingRetryDelay: 500,
			fragLoadingMaxRetryTimeout: 44000, //64000,
				...
				if (!_mejs2['default'].html5media.readOnlyProperties.includes(propName)) {
					if (hlsPlayer !== null) {
						...
						if (propName === 'src') {
							...
							_window2['default'].loadSource = function () {
								hlsPlayer.loadSource(value);
								hlsPlayer.off(Hls.Events.MEDIA_ATTACHED, _window2['default'].loadSource);
							};
							hlsPlayer.attachMedia(node);
							hlsPlayer.on(Hls.Events.MEDIA_ATTACHED, loadSource);
						}
					} else {
						// store for after "READY" event fires
						stack.push({ type: 'set', propName: propName, value: value });
...
},{"2":2,"22":22,"23":23,"25":25,"3":3,"6":6,"7":7}],21:[function(_dereq_,module,exports){
'use strict';
...
},{"2":2,"6":6}],24:[function(_dereq_,module,exports){
'use strict';
...
},{"2":2,"6":6}],25:[function(_dereq_,module,exports){
'use strict';
...
function getTypeFromFile(url) {
	...
	//微信支持rtmp 原生播放
	if (url.indexOf("rtmp") == 0 && navigator.userAgent.toLowerCase().match(/MicroMessenger/i) == 'micromessenger') {
		return 'application/x-mpegURL';
	}
...
},{"6":6}]},{},[26,5,4,14,21,18,17,19,20,15,16,8,9,10,11,12,13]);
